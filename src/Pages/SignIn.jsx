    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-purple-50 flex items-center justify-center py-12 px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          {/* Header */}
          <div className="bg-gradient-to-r from-orange-500 to-pink-700 p-8 text-center">
            <div className="mb-4">
              <Link
                to="/Home"
                className="text-4xl font-black text-white hover:text-orange-200 transition-colors duration-200"
              >
                DUNKIN'
              </Link>
            </div>
          ...
          {loginStatus === "success" && (
            <div className="mx-8 mt-6 p-4 bg-green-50 border border-green-200 rounded-xl">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="font-bold text-green-800">Welcome Back!</p>
                  <p className="text-sm text-green-600">You have successfully signed in.</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    className="w-4 h-4 text-pink-700 border-gray-300 rounded focus:ring-pink-500 focus:ring-2"
                  />
                  <span className="ml-2 text-sm text-gray-600">Remember me</span>
                </label>
                <Link
                  to="/forgot-password"
                  className="text-sm text-pink-700 hover:text-pink-800 font-medium hover:underline transition-colors duration-200"
                >
                  Forgot Password?
                </Link>
              </div>
            ...
            <div className="mt-8 text-center">
              ...
              <Link
                to="/join"
                className="inline-block bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-bold py-3 px-8 rounded-full transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                JOIN US
              </Link>
              <p className="text-sm text-gray-500 mt-3">
                Join Dunkin' Rewards and start earning points on every purchase!
              </p>
            </div>
          </div>
        </div>
